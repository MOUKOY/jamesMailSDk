...
/**
 * @Description 类说明：附件的操作类
 * @Author fanpei
 * @CreateTime 2018年4月26日 下午3:17:04
 */
@Deprecated
public class AttachFileUtil {
	...
	public boolean isDownload(String filename) {
		...
		int n = JOptionPane.showConfirmDialog(null, "该邮件具有附件  \"" + filename + "\" 是否下载？", "询问",
	...
	public void downloadFile(String filename, InputStream in) {// filename
		...
		try {
			...
			JOptionPane.showMessageDialog(null, "附件   \"" + filename + "\"下载成功！", "提示",
